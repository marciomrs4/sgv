...
$Usuario = $tbUsuario->getFormUser($_SESSION['administracao/alterar/usuario']);
	...
	<div class="panel-body">
		<form class="form-horizontal" method="post" action="action/usuario.php" role="form">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" name="usu_nome" value="<?php echo($Usuario['usu_nome']); ?>" class="form-control" id="usu_nome"
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" name="usu_login" value="<?php echo($Usuario['usu_login']); ?>" class="form-control" id="usu_login"
